import { TrajectoryOscillator } from './modules/TrajectoryOscillator.js';
import { EnvelopeModule } from './modules/EnvelopeModule.js';
import { ReverbModule } from './modules/ReverbModule.js';

const sampleRate = globalThis.sampleRate;

class TrajectoryProcessor extends AudioWorkletProcessor {
  constructor() {
    super();

    this.sampleRate = sampleRate;
    this.oscillator = new TrajectoryOscillator(this.sampleRate);
  ...
  handleMessage(message) {
    ...
    switch (message.type) {
      case 'init':
        ...
        this.oscillator.configure(this.params);
        if (message.envelope) {
      ...
      case 'noteOn':
        ...
        this.oscillator.setFrequency(this.voice.frequency);
...
registerProcessor('trajectory-processor', TrajectoryProcessor);
