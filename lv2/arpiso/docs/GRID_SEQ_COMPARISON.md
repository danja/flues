# ArpIso Implementation Notes (Legacy Filename)

This file previously compared other grid sequencers. It now documents ArpIso's core behavior so the filename does not mislead new readers.
