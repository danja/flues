...
static const char* kSliderLabels[PROGRAM_MAX + 1][SLIDER_COUNT] = {
    ...
    {"Sides", "Start\nPos", "Start\nAngle", "Jitter", "Clip", "Mix X", "Mix Y", "Attack", "Release"},
    {"F1", "F2", "F3", "F4", "Noise", "Nasal", "Jitter", "Attack", "Release"},
    {"F1", "F2", "F3", "F4", "Disyn\nLevel", "Noise", "Jitter", "Attack", "Release"},
    {"Delay1 FB", "Delay2 FB", "Filter FB", "Interface", "Intensity", "Tuning", "Ratio", "Attack", "Release"},
    {"Delay1 FB", "Delay2 FB", "Filter FB", "Interface", "Intensity", "Tuning", "Ratio", "Attack", "Release"},
    {"Alg", "Param1", "Param2", "Disyn\nLevel", "Intensity", "Tuning", "Ratio", "Attack", "Release"},
    {"Index", "Ratio", "F1", "F2", "F3", "F4", "Jitter", "Attack", "Release"},
    {"Decay", "Ratio", "Delay1 FB", "Delay2 FB", "Intensity", "Tuning", "Delay\nRatio", "Attack", "Release"},
    {"Formant", "Bandw", "Filter\nFreq", "Filter Q", "Filter\nShape", "Tuning", "Jitter", "Attack", "Release"},
    {"Decay", "Ratio", "F1", "F2", "F3", "Tuning", "Jitter", "Attack", "Release"},
    {"Drive", "Blend", "Filter\nFreq", "Filter Q", "Filter\nShape", "Filter FB", "Intensity", "Attack", "Release"},
    {"Decay", "Ratio", "F1", "F2", "F3", "F4", "Jitter", "Attack", "Release"},
    {"Index", "Ratio", "Delay1 FB", "Delay2 FB", "Filter FB", "Tuning", "Delay\nRatio", "Attack", "Release"},
    {"Harmonics", "Tilt", "Filter\nFreq", "Filter Q", "Filter\nShape", "Tuning", "Jitter", "Attack", "Release"},
    {"Alg", "Param1", "Param2", "Disyn\nLevel", "Intensity", "Tuning", "Jitter", "Attack", "Release"},
    {"Decay", "Ratio", "Filter\nFreq", "Filter Q", "Filter\nShape", "Delay1 FB", "Filter FB", "Attack", "Release"},
    {"ModFM\nIdx", "PAF\nBandw", "Formant\nSpace", "Disyn\nLevel", "Intensity", "Tuning", "Jitter", "Attack", "Release"},
    {"DSF\nDecay", "Asym\nRatio", "Tanh\nDrive", "Filter\nFreq", "Filter Q", "Intensity", "Jitter", "Attack", "Release"},
    {"ModFM\nIdx", "PAF\nBandw", "Mix", "Intensity", "Tuning", "Filter\nFreq", "Jitter", "Attack", "Release"},
    {"ModFM\nIdx", "Feedback\nGain", "Feedback\nLP", "Intensity", "Tuning", "Filter\nFreq", "Jitter", "Attack", "Release"},
    {"Morph", "Character", "Curve", "Intensity", "Tuning", "Filter\nFreq", "Jitter", "Attack", "Release"},
    {"DSF\nDecay", "PAF\nShift", "PAF\nFormant", "Tuning", "Intensity", "Delay1 FB", "Jitter", "Attack", "Release"},
    ...
    {"First\nTerms", "Second\nTerms", "Blend", "Jitter", "-", "-", "-", "Attack", "Release"},
